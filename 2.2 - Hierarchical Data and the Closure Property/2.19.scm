...
(cc 100 (list 2 8 4 30)) ;312
(cc 100 (list 30 2 4 8)) ;312
(cc 100 (list 2 30 4 8)) ;312

; It looks like the order of coins doesn't matter. But why?
; The way the procedure works is roughly:
; Choose a coin and add up the ways to change coins by choosing this coin as the
; first and the number of ways to choose coins starting with a different coin.
; So the procedure actually adds up the number of ways to count the change
; starting with any of the coins - so in the end the order doesn't matter.
